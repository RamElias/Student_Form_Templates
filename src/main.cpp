...
// >> operator reads an int and << operator printFields faculty name if the value is
...
// printFields welcome message to the given std::ostream
void displayWelcomeMessage();

// printFields goodbye message to the given std::ostream
void displayGoodbyeMessage();

// printFields error message to the given std::ostream
void displayErrorMessage();

// printFields form to the given std::ostream
